...
class TrainingEnv:
    def __init__(self,params: dict = {}):
        ...
        self._agent = Agent(params.get("observation_space",15),params.get("action_space",6),random.random())
    ...
    def _run_episode(self):
        ...
        for t in count():
            ...
            action = self._agent.act(state,True)
            try:
            ...
            self._agent.step(state,action,next_state,reward,done)
